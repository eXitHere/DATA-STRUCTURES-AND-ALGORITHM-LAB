class Graph:
    ...
    def _min_distance(self, dist, visited):
        ...
        for vertex in self.weight:
            if dist[vertex][0] < min_ and vertex not in visited:
                min_ = dist[vertex][0]
                min_index = vertex
        return min_index
    ...
    def dijkstra(self, start):
        ...
        dist = dict()
        for vertex in self.weight:
            dist[vertex] = [1000000000000000, vertex]
        dist[start] = [0, start]
        for key in self.weight:
            u = self._min_distance(dist, visited)
            visited.add(u)
            for pair in self.weight[u]:
                v = pair[0]
                w = pair[1]
    ...
    def dijkstra_AB(self, src, dest):
        ...
        if dist[dest][0] == 1000000000000000:
            print("Not have path :", src, "to", dest)
            return
        if src == dest:
            return [src]
        lst = [src]
...
if __name__ == '__main__':
    station = {
        "Acton Town":
        ["Ealing Common", "South Ealing", "Turnham Green", "Chiswick Park"],
        ...
        "Baker Street": [
            "Marylebone", "Regent's Park", "Edgware Road (C)",
            "Great Portland Street", "Bond Street", "St. John's Wood",
            "Finchley Road"
        ],
        "Balham": ["Clapham South", "Tooting Bec"],
        "Bank": [
            "Liverpool Street", "St. Paul's", "Shadwell", "London Bridge",
            "Moorgate", "Waterloo"
        ],
        ...
        "Bond Street":
        ["Marble Arch", "Oxford Circus", "Green Park", "Baker Street"],
        ...
        "Camden Town":
        ["Chalk Farm", "Euston", "Kentish Town", "Mornington Crescent"],
        "Canada Water":
        ["Rotherhithe", "Surrey Quays", "Canary Wharf", "Bermondsey"],
        "Canary Wharf":
        ["Heron Quays", "West India Quay", "North Greenwich", "Canada Water"],
        "Canning Town":
        ["East India", "Royal Victoria", "North Greenwich", "West Ham"],
        ...
        "Charing Cross":
        ["Embankment", "Picadilly Circus", "Leicester Square"],
        ...
        "Earl's Court": [
            ...
            "Kensington (Olympia)", "West Brompton", "West Kensington",
            "Barons Court"
        ],
        ...
        "Epping": ["Theydon Bois"],
        "Euston": [
            "King's Cross St. Pancras", "Mornington Crescent", "Warren Street",
            "Camden Town"
        ],
        ...
        "Finchley Central":
        ["Mill Hill East", "West Finchley", "East Finchley"],
        "Finchley Road":
        ["Swiss Cottage", "West Hampstead", "Wembley Park", "Baker Street"],
        "Finsbury Park":
        ["Manor House", "Highbury & Islington", "Seven Sisters", "Arsenal"],
        "Fulham Broadway": ["Parsons Green", "West Brompton"],
        "Gallions Reach": ["Beckton", "Cyprus"],
        "Gants Hill": ["Newbury Park", "Redbridge"],
        "Gloucester Road":
        ["High Street Kensington", "South Kensington", "Earl's Court"],
        ...
        "Green Park": [
            "Westminster", "Hyde Park Corner", "Picadilly Circus",
            "Oxford Circus", "Victoria", "Bond Street"
        ],
        ...
        "Hammersmith":
        ["Ravenscourt Park", "Turnham Green", "Barons Court", "Goldhawk Road"],
        ...
        "Harrow-on-the-Hill": [
            "Northwick Park", "North Harrow", "West Harrow"
        ],
        "Hatton Cross": [
        ...
        "King's Cross St. Pancras": [
            "Russell Square", "Angel", "Caledonian Road", "Euston",
            "Euston Square", "Farringdon", "Highbury & Islington"
        ],
        ...
        "Leicester Square": [
            "Tottenham Court Road", "Picadilly Circus", "Charing Cross",
            "Covent Garden"
        ],
        ...
        "Liverpool Street": [
            "Moorgate", "Aldgate", "Aldgate East", "Bank", "Bethnal Green"
        ],
        ...
        "Mile End": [
            "Stratford", "Stepney Green", "Bethnal Green", "Bow Road"
        ],
        ...
        "Notting Hill Gate": [
            "Queensway", "Bayswater", "High Street Kensington", "Holland Park"
        ],
        ...
        "Oxford Circus": [
            "Picadilly Circus", "Regent's Park", "Tottenham Court Road",
            "Warren Street", "Bond Street", "Green Park"
        ],
        "Paddington": [
            "Warwick Avenue", "Royal Oak", "Bayswater", "Edgware Road (B)",
            "Edgware Road (C)"
        ],
        ...
        "Picadilly Circus": [
            "Charing Cross", "Green Park", "Leicester Square", "Oxford Circus"
        ],
        ...
        "Shadwell": [
            "Tower Gateway", "Wapping", "Whitechapel", "Bank", "Limehouse"
        ],
        ...
        "South Kensington": [
            "Gloucester Road", "Knightsbridge", "Sloane Square"
        ],
        ...
        "Tottenham Court Road": [
            "Goodge Street", "Holborn", "Leicester Square", "Oxford Circus"
        ],
        ...
        "Turnham Green": [
            "Acton Town", "Chiswick Park", "Gunnersbury", "Hammersmith",
            "Stamford Brook"
        ],
        ...
        "Victoria": [
            "Green Park", "Pimlico", "Sloane Square", "St. James's Park"
        ],
        ...
        "Waterloo": [
            "Westminster", "Bank", "Embankment", "Kennington", "Lambeth North",
            "Southwark"
        ],
        "Watford": ["Croxley"],
        "Wembley Central": ["North Wembley", "Stonebridge Park"],
        "Wembley Park": [
            "Finchley Road", "Kingsbury", "Neasden", "Preston Road"
        ],
        ...
        "West Ham": [
            "Bromley-By-Bow", "Canning Town", "Plaistow", "Stratford"
        ],
        ...
        "Westminster": [
            "Embankment", "Green Park", "St. James's Park", "Waterloo"
        ],
        "White City": ["East Acton", "Shepherd's Bush (C)"],
        "Whitechapel": [
            "Aldgate East", "Shadwell", "Shoreditch", "Stepney Green"
        ],
